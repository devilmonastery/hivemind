...
func (UnimplementedAuthServiceServer) LoginWithOIDC(context.Context, *LoginWithOIDCRequest) (*LoginWithOIDCResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoginWithOIDC not implemented")
}
...
func (UnimplementedAuthServiceServer) AuthenticateLocal(context.Context, *AuthenticateLocalRequest) (*AuthenticateLocalResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthenticateLocal not implemented")
}
